...
> NOTE: As of v0.2.0, all `coin_history_*()` functions could retrieve data for up 30 coins in one call. However, this number had to be scaled down to 5 in v0.3.0 due to the significantly lower API rate limit imposed by CoinGecko.
