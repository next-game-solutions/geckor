...
current and historical market data on over 8000 cryptocurrencies from more than 300 exchanges. Results are typically returned in a tabular form as [tibbles](https://tibble.tidyverse.org/), ready for any downstream analyses.
...
The public [CoinGecko API](https://www.coingecko.com/api/documentations/v3), has a limit of 50 calls per minute. Please keep this limit in mind when developing your applications using the `geckor` package.
